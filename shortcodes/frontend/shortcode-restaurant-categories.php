    ...
    class Foodbakery_Shortcode_Restaurant_Categories_front {
	    ...
	    $count = count($all_types);
            if ( is_array( $all_types ) && $count > 0 ) {
                ...
                echo '<div class="categories-holder '.$foodbakery_var_categories_style.' swiper-container">';
                if( $foodbakery_var_categories_style == 'categories_slider'){
                    echo '<div class="swiper-wrapper">';
                }
                $list_item_class = ($foodbakery_var_categories_style == 'categories_slider')? 'swiper-slide' : '';
                foreach ( $all_types as $type ) {
                    ...
                    if ( $type != '' ) {
                        ...
                        echo '<div class="col-lg-2 col-sm-4 col-xs-6 category-items '.$list_item_class.'">
