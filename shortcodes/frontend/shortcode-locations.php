...
if ( ! class_exists( 'Foodbakery_Shortcode_Locations_front' ) ) {
    ...
    class Foodbakery_Shortcode_Locations_front {
	    ...
	    echo '<div class="row"><div class="col-lg-12 col-md-12 col-sm-6 col-xs-12">';
	    $count = count($all_types);
            ...
            echo '</div><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="more-btn-holder"><a class="more-btn" href="'.esc_url($locations_button_url).'">'.esc_html__('See more locations', 'foodbakery').'</a></div></div>';
            echo '</div>';
	      echo '</div>';
            if (function_exists('foodbakery_var_page_builder_element_sizes')) {
             echo  '</div>';
