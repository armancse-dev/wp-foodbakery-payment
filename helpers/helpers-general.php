...
if ( class_exists('wp_foodbakery_framework') ) {
    ...
    if ( ! function_exists('foodbakery_plugin_db_structure_updater_demo_callback') ) {
        ...
        function foodbakery_plugin_db_structure_updater_demo_callback() {
            ...
            $remote_api_url = 'http://localhost/webservice';
...
if ( ! function_exists('get_restaurant_id_by_publisher') ) {

    function get_restaurant_id_by_publisher($publisher_id) {
        ...
        $restaurant_id = isset( $pub_restaurant[0] )? $pub_restaurant[0] : 0;
...
if ( ! function_exists('get_restaurant_id_by_publisher_id') ) {

    function get_restaurant_id_by_publisher_id($publisher_id) {
        $current_user = wp_get_current_user();
        $args = array(
            'posts_per_page' => "1",
            'post_type' => 'restaurants',
