...
if (!function_exists('foodbakery_open_close_status')) {
    ...
    function foodbakery_open_close_status($id = '') {
        ...
        $current_time = apply_filters('foodbakery_current_time', $current_time);
...
if (!function_exists('foodbakery_iconlist_plugin_options')) {
    ...
    function foodbakery_iconlist_plugin_options($icon_value = '', $id = '', $name = '', $class = '') {
        ...
        $foodbakery_opt_array = array(
            ...
            'extra_atr' => 'data-js_id="_menu_cat_icon"',
        );
...
$umlaut_chars['utf8'] = array(mb_convert_encoding('Ä', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('ä', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('Ö', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('ö', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('Ü', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('ü', 'UTF-8', 'ISO-8859-1'), mb_convert_encoding('ß', 'UTF-8', 'ISO-8859-1'));
...
if (!function_exists('restaurant_menu_price_calc')) {
    ...
    function restaurant_menu_price_calc($get_added_menus = '', $foodbakery_restaurant_id = '', $fee = false, $vat = false, $only_vat = false, $converter = false, $order_id = '', $currency_symbol = false, $apply_filter = true) {
        global $foodbakery_plugin_options;
                ...
                if (isset($menu_ord_item['menu_id']) && isset($menu_ord_item['price'])) {
                    ...
                    if (is_array($this_item_extras) && sizeof($this_item_extras) > 0) {
                        foreach ($this_item_extras as $this_item_extra_at) {
                            $item_extra_at_price = isset($this_item_extra_at['price']) ? $this_item_extra_at['price'] : 0;
                            $item_extra_at_price = ( $item_extra_at_price > 0) ? $item_extra_at_price : 0;
                            $this_item_quantity = ( $this_item_quantity > 0 ) ? $this_item_quantity : 1;
        ...
        if (true === $fee) {
            ...
            if ($selected_fee_type == 'delivery') {
                if ($woocommerce_enabled == 'on') {
                    $woocommerce_fee_data['deliver']['label'] = esc_html__('Delivery', 'foodbakery');
                    $woocommerce_fee_data['deliver']['value'] = floatval($foodbakery_delivery_fee);
                }
                $menu_t_price += floatval($foodbakery_delivery_fee);
            } else if ($selected_fee_type == 'pickup') {
                if ($woocommerce_enabled == 'on') {
                    $woocommerce_fee_data['pickup']['label'] = esc_html__('Pickup', 'foodbakery');
                    $woocommerce_fee_data['pickup']['value'] = floatval($foodbakery_pickup_fee);
                }
            ...
            /* else {
              ...
              $menu_t_price += floatval($foodbakery_delivery_fee);
              } else if ($restaurant_pickup_delivery == 'pickup' || $restaurant_pickup_delivery == 'delivery_and_pickup') {
              if ($woocommerce_enabled == 'on') {
              $woocommerce_fee_data['pickup']['label'] = esc_html__('Pickup', 'foodbakery');
              $woocommerce_fee_data['pickup']['value'] = floatval($foodbakery_pickup_fee);
              }
        ...
        if( $apply_filter == true){
            $menu_t_price = apply_filters('foodbakery_order_total_amount', $menu_t_price, $order_id, $foodbakery_restaurant_id);
        }
        $woocommerce_fee_data = apply_filters('foodbakery_woocommerce_fee_data_update', $woocommerce_fee_data, $order_id);
...
function restaurant_detail_menu_list($foodbakery_restaurant_id = '', $single_restaurant_view = 'simple') {
    ...
    if (is_array($restaurant_menu_list)) {
        foreach ($restaurant_menu_list as $menu_key => $menu_data) {
            $menu_exists = in_array($restaurant_menu_list[$menu_key]['restaurant_menu'], $total_menu);
            if (!$menu_exists) {
                $total_menu[] = $restaurant_menu_list[$menu_key]['restaurant_menu'];
            }
        }
    }
    ...
    if (!empty($restaurant_menu_cat_title)) {
        foreach ($restaurant_menu_cat_title as $cat_title_key => $cat_title_value) {
            $category_titles_array[$cat_title_value] = $cat_title_key;
        }
    }
    
    $total_menu = apply_filters('foodbakery_menu_items_sorting', $total_menu, $restaurant_menu_cat_title);

    foreach ($total_menu as $total_menu_key => $total_menu_data) {
        ob_start();
        $restaurant_menu = esc_html($total_menu_data);
        $menu_items_loop = 0;
        foreach ($restaurant_menu_list as $menu_key => $menu_data) {
            $restaurant_menu_category = isset($menu_data['restaurant_menu']) ? $menu_data['restaurant_menu'] : '';

            $menu_items_loop = $menu_key;
            if ($restaurant_menu_category == $restaurant_menu) {

                $show_menu_items = apply_filters('foodbakery_show_menu_items', true, $foodbakery_restaurant_id, $restaurant_menu_category, $category_titles_array);

                if ($show_menu_items == true) {


                    $menu_item_title = isset($menu_data['menu_item_title']) ? $menu_data['menu_item_title'] : '';
                    $menu_item_identity = isset($menu_data['menu_item_identity']) ? $menu_data['menu_item_identity'] : '';
                    $menu_item_description = isset($menu_data['menu_item_description']) ? $menu_data['menu_item_description'] : '';
                    $menu_item_icon = isset($menu_data['menu_item_icon']) ? $menu_data['menu_item_icon'] : '';
                    $menu_item_nutri = isset($menu_data['menu_item_nutri']) ? $menu_data['menu_item_nutri'] : '';
                    $menu_item_price = isset($menu_data['menu_item_price']) ? $menu_data['menu_item_price'] : '';
                    $menu_item_calories = isset($menu_data['menu_item_calories']) ? $menu_data['menu_item_calories'] : '';
                    $menu_item_extra = isset($menu_data['menu_item_extra']) ? $menu_data['menu_item_extra'] : '';
                    $menu_item_stock = isset($menu_data['menu_item_stock']) ? $menu_data['menu_item_stock'] : 1000;
                    ...
                    <li class="<?php echo esc_attr($list_item_class); ?>">
                        ...
                        <div class="text-holder">
                            ...
                            <h6><?php echo esc_html($menu_item_title); ?>
                                <?php
                                if ($menu_item_calories > 0) {
                                    echo '<i class="icon-cutlery" style="font-size: 10px;background: #c33332;color: #ffffff;padding: 3px;border-radius: 50%;" title="Calories: ' . $menu_item_calories . '"></i>';
                                }
                                ?>
                            </h6>
                        ...
                        <div class="price-holder">
                            ...
                            if ($restaurant_menu_order_active == true) {
                                ...
                                if (isset($menu_item_extra[0]['title']) && is_array($menu_item_extra[0]['title']) && sizeof($menu_item_extra[0]['title']) > 0) {
                                    ...
                                    ?>
                                    <a href="javascript:void(0);" data-menu_rand_id="<?php echo absint($menu_item_identity); ?>" data-item_stock="<?php echo absint($menu_item_stock); ?>" class="menu_rand_id_<?php echo absint($menu_item_identity); ?> dev-adding-menu-btn-<?php echo absint($menu_items_loop) ?>" onclick="foodbakery_show_extra_menu_item('extras-<?php echo absint($total_menu_key) ?>-<?php echo absint($menu_items_loop) ?>', '<?php echo absint($menu_items_loop) ?>', '<?php echo absint($total_menu_key) ?>', '<?php echo $ajax_url; ?>', '<?php echo $foodbakery_restaurant_id; ?>', '<?php echo $single_restaurant_view; ?>', this);"><i class="icon-plus4 text-color"></i></a>
                                    <?php
                                } else {
                                    ?>
                                    <a href="javascript:void(0)" data-menu_rand_id="<?php echo absint($menu_item_identity); ?>" data-item_stock="<?php echo absint($menu_item_stock); ?>" data-menu_item_identity="<?php echo absint($menu_item_identity) ?>" class="menu_rand_id_<?php echo absint($menu_item_identity); ?> restaurant-add-menu-btn restaurant-add-menu-btn-<?php echo absint($menu_items_loop) ?>" data-rid="<?php echo absint($foodbakery_restaurant_id) ?>" data-id="<?php echo absint($menu_items_loop) ?>" data-cid="<?php echo absint($total_menu_key) ?>"><i class="icon-plus4 text-color"></i></a>
                                    <?php
                                }
                            }
                            ?>
                        ...
                        <?php do_action('foodbakery_after_menu_item_data', $restaurant_menu_list, $menu_item_identity); ?>
        ...
        if ($menu_it_html != '') {
            ...
            <div class="element-title" id="menu-category-<?php echo absint($total_menu_key) ?>">
                <h5 class="text-color"><?php echo esc_html($total_menu[$total_menu_key]); ?></h5>
                <span><?php echo isset($restaurant_menu_cat_desc[$total_menu_key]) ? esc_html($restaurant_menu_cat_desc[$total_menu_key]) : ''; ?></span>
            </div>
...
function restaurant_detail_menu_list_bk($foodbakery_restaurant_id = '', $single_restaurant_view = 'simple') {
    ...
    for ($menu_loop = 0; $menu_loop < $total_menu_count; $menu_loop ++) {
        ...
        for ($menu_items_loop = 0; $menu_items_loop < $total_items; $menu_items_loop ++) {
            if (isset($restaurant_menu_list[$menu_items_loop]['restaurant_menu']) && $total_menu[$menu_loop] == $restaurant_menu_list[$menu_items_loop]['restaurant_menu']) {
                ...
                $menu_item_calories = isset($restaurant_menu_list[$menu_items_loop]['menu_item_calories']) ? $restaurant_menu_list[$menu_items_loop]['menu_item_calories'] : '';
                ...
                $menu_item_calories = isset($restaurant_menu_list[$menu_items_loop]['menu_item_calories']) ? $restaurant_menu_list[$menu_items_loop]['menu_item_calories'] : 0;
                    ...
                    <div class="price-holder">
                        ...
                        if ($restaurant_menu_order_active == true) {
                            if (isset($menu_item_extra[0]['title']) && is_array($menu_item_extra[0]['title']) && sizeof($menu_item_extra[0]['title']) > 0) {
                                $ajax_url = admin_url('admin-ajax.php');
                                ?>
                                <a href="javascript:void(0);" data-menu_rand_id="<?php echo absint($menu_item_identity); ?>" data-item_stock="<?php echo absint($menu_item_stock); ?>" class="menu_rand_id_<?php echo absint($menu_item_identity); ?> dev-adding-menu-btn-<?php echo absint($menu_items_loop) ?>" onclick="foodbakery_show_extra_menu_item('extras-<?php echo absint($menu_loop) ?>-<?php echo absint($menu_items_loop) ?>', '<?php echo absint($menu_items_loop) ?>', '<?php echo absint($menu_loop) ?>', '<?php echo $ajax_url; ?>', '<?php echo $foodbakery_restaurant_id; ?>', '<?php echo $single_restaurant_view; ?>', this);"><i class="icon-plus4 text-color"></i></a>
                                <?php
                            } else {
                                ?>
...
if (!function_exists('foodbakery_show_extra_menu_item')) {
    ...
    function foodbakery_show_extra_menu_item() {
        ...
        $single_restaurant_view = isset($_POST['single_restaurant_view']) ? $_POST['single_restaurant_view'] : 'simple';
        //pre($single_restaurant_view);
        $menu_item_identity = isset($_POST['menu_item_identity']) ? $_POST['menu_item_identity'] : '';


        $data_id = $menu_item_identity;

        $restaurant_menu_list = get_post_meta($foodbakery_restaurant_id, 'foodbakery_menu_items', true);

        $Foodbakery_deal_backend = new Foodbakery_deal_backend();
        $menu_item_data = $Foodbakery_deal_backend->foodbakery_get_menu_item($foodbakery_restaurant_id, $menu_item_identity);
        //pre($menu_item_data);
        //pre($restaurant_menu_list);
        ob_start();
        ...
        $style_content_fancy = ($single_restaurant_view == 'fancy') ? 'style="position: inherit;"' : '';
        $style_body_fancy = ($single_restaurant_view == 'fancy') ? 'style="padding: 0px 20px 20px 20px;"' : '';
        $menu_item_title = ( $menu_item_data['menu_item_title'] ) ? $menu_item_data['menu_item_title'] : '';
        $menu_item_description = ( $menu_item_data['menu_item_description'] ) ? $menu_item_data['menu_item_description'] : '';
        ...
        $menu_item_icon_img_arr = wp_get_attachment_image_src($menu_item_icon, 'large');
        $menu_item_icon_img_src = isset($menu_item_icon_img_arr[0]) ? $menu_item_icon_img_arr[0] : '';

        //pre($menu_item_extra[0]['title']);
        $model_class = ($single_restaurant_view == 'fancy') ? 'fb-fancy-extras' : '';
        if (isset($menu_item_extra[0]['title']) && is_array($menu_item_extra[0]['title']) && sizeof($menu_item_extra[0]['title']) > 0) {
            ?>
            <div class="modal fade menu-extras-modal extras-deal-modal add_extrass <?php echo $model_class; ?>" id="<?php echo $pop_up_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" <?php echo $style_content_fancy; ?>>
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h2><a><?php echo $menu_item_title; ?>
                                    <?php
                                    if ($menu_item_calories > 0) {
                                        echo '<i class="icon-cutlery" style="font-size: 14px;background: #df6f6f;color: #ffffff;padding: 6px;border-radius: 50%;" title="Calories: ' . $menu_item_calories . '"></i>';
                                    }
                                    ?>

                                    <?php //esc_html_e('Extras', 'foodbakery')  ?></a></h2>
                        </div>

                        <?php if ($single_restaurant_view == 'fancy') { ?>

                            <div class="modal-body" <?php echo $style_body_fancy; ?>>
                                <div class="menu-selection-container">
                                    <div class="extras-detail-main1">
                                        <div class="tab-content">
                                            <div id="deal_item_83480" class="tab-pane fade in active">
                                                <div class="extras-detail-main1">
                                                    <div class="main-holder">
                                                        <figure><img src="<?php echo esc_url($menu_item_icon_img_src); ?>"></figure>
                                                    </div>
                                                    <div class="extras-detail-options">
                                                        <div class="text-holder" style="margin-bottom: 30px;">
                                                            <h2 style="display: none; float: none; margin-bottom: 15px;"><?php //echo $menu_item_title;   ?>
                                                        ...
                                                        if (isset($menu_item_extra[0]['title']) && is_array($menu_item_extra[0]['title']) && sizeof($menu_item_extra[0]['title']) > 0) {
                                                            foreach ($menu_item_extra['heading'] as $key => $value) {
                                                                ...
                                                                if (is_array($menu_item_extra_titles) && sizeof($menu_item_extra_titles) > 0) {
                                                                    $menu_extra_att_counter = 0;
                                                                    ?>
                                                                    <div class="extras-detail-main" id="menu_idd_<?php echo $menu_item_identity . $menu_extra_counter; ?>">
                                                                        <input type="hidden" name="required_count" value="<?php echo $required_num_value; ?>">
                                                                            ...
                                                                            foreach ($menu_item_extra_titles as $key => $menu_item_extra_title) {
                                                                                ...
                                                                                <div class="extras-detail-att">
                                                                                    ...
                                                                                    <label for="extra-<?php echo absint($menu_extra_att_counter) ?>-<?php echo absint($menu_extra_counter) ?>-<?php echo absint($menu_items_loop) ?>">
                                                                                        ...
                                                                                        <span class="extra-title"><?php echo esc_html($menu_item_extra_title) ?>
                                ...
                                <div class="modal-footer">
                                    <a data-menucat-id="<?php echo absint($data_cat_id) ?>" data-unique-menu-id="<?php echo esc_attr($menu_item_identity); ?>" data-menu-id="<?php echo esc_attr($data_id); ?>" data-rid="<?php echo esc_attr($foodbakery_restaurant_id); ?>" class="add-extra-menu-btn btn-add-to-cart input-button-loader">Add to Cart</a>
                                </div>
                            </div>
...
if (!function_exists('foodbakery_cart_total_callback')) {

    function foodbakery_cart_total_callback() {
        ...
        $total_response = apply_filters('foodbakery_cart_total_response', $total_response, $restaurant_id);
        
        echo json_encode($total_response);
        die();
    }
    
    add_action('wp_ajax_foodbakery_cart_total', 'foodbakery_cart_total_callback', 10);
    add_action('wp_ajax_nopriv_foodbakery_cart_total', 'foodbakery_cart_total_callback', 10);
