...
function foodbakery_insert_menu_deals_frontend($restaurant_id) {
...
if ($publisher_profile_type == 'restaurant') {
    ...
    if (isset($pub_restaurant[0]) && $pub_restaurant[0] != '' && isset($_POST['food_menu_updating']) && $_POST['food_menu_updating'] == '1') {
            ...
            foreach ($foodbakery_restaurant_menu_item_title as $key => $menu_item) {
                ...
                if ($menu_item != '' && $menu_item_action != 'add') {
                    $items_array = array(
                        ...
                        'menu_item_identity' => $key,
                    );
                    $menu_items_array[$key] = apply_filters('foodbakery_menu_saving_frontend', $items_array, $key);
                }
            }
        }
        ...
        foodbakery_insert_menu_deals_frontend($restaurant_id);
        ...
        <div class="main-section ">
            <div class="page-content-fullwidth">
                <div class="row">
                    ...
                    $foodbakery_restaurant_cover_styles = '';
                    $foodbakery_restaurant_id   = get_the_ID();
                            ...
                            <div class="row">
                                ...
                                <div id="main">
                                                    ...
                                                    <div class="user-account-nav user-account-sidebar">
                                                        ...
                                                        <div class="user-nav-list">
                                                            <ul>
																...
																do_action('foodbakery_dashboard_leftside_link', $publisher_profile_type);
																
                                                                if ($publisher_profile_type == 'individual') {
                                                                ...
                                                                if ($publisher_profile_type == 'restaurant') {
                                                                    ...
                                                                    ?>
                                                                    <?php do_action('foodbakery_restaurant_dashboard_menu', isset( $foodbakery_restaurant_id )? $foodbakery_restaurant_id : 0); ?>
                                                                    ...
                                                                    if (true === Foodbakery_Member_Permissions::check_permissions('orders') || true === Foodbakery_Member_Permissions::check_permissions('inquiries')) {
                                                                        ...
                                                                        if (true === Foodbakery_Member_Permissions::check_permissions('orders')) {
                                                                            $restaurant_menu_order_active = apply_filters('restaurant_menu_order_active_by_publisher', true, $publisher_id);
                                                                    ...
                                                                    do_action('restaurant_dashboard_left_menu');
                                    ...
                                    <div class="page-section">
                                     ...
                                     <?php do_action('foodbakery_dashboard_page_end'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
