...
if (!function_exists('foodbakery_settings_options_page')) {
    ...
    function foodbakery_settings_options_page() {
        ...
        //$return = apply_filters('foodbakery_plugin_fields_load', $return, $foodbakery_plugin_options);
        ...
        if (class_exists($foodbakery_plugin_fields_class)) {
            $options_buttons_html = $foodbakery_form_fields->foodbakery_form_text_render($foodbakery_opt_btn_array);    
            $options_buttons_html .= $foodbakery_form_fields->foodbakery_form_hidden_render($foodbakery_opt_hidden1_array);    
            $options_buttons_html .= $foodbakery_form_fields->foodbakery_form_hidden_render($foodbakery_opt_hidden2_array);    
            $options_buttons_html .= $foodbakery_form_fields->foodbakery_form_text_render($foodbakery_opt_btn_cancel_array);    
        }
...
if (!function_exists('foodbakery_settings_option')) {
    ...
    function foodbakery_settings_option() {
        ...
        $foodbakery_setting_options[] = array("name" => esc_html__("User Header Login", "foodbakery"),
            "desc" => "",
            "hint_text" => esc_html__("Front-End login/register option can be hided by turning off this switch.", "foodbakery"),
        ...
        $foodbakery_setting_options[] = array(
            ...
            "desc" => "",
            "hint_text" => esc_html__("Assign page for publisher dashboard here. Set the page template from sidebar as ‘Publisher’ in it.", "foodbakery"),
        ...
        $foodbakery_setting_options[] = array(
            ...
            "desc" => "",
            "hint_text" => esc_html__("Assign page for ‘order details’ to show submit order page.", "foodbakery"),
        ...
        $foodbakery_setting_options[] = array(
         ...
         $foodbakery_setting_options[] = array(
                "name" => esc_html__("Single Restaurant Style", "foodbakery"),
                "desc" => "",
                "id" => "single_restaurant_style",
                "std" => "Left",
                'classes' => 'dropdown chosen-select-no-single',
                "type" => "select",
                "custom" => true,
                "options" => array('simple' => 'Simple', 'fancy' => 'Fancy'),
            );
         
         $foodbakery_setting_options = apply_filters('foodbakery_general_plugin_options_block', $foodbakery_setting_options);
        ...
        $foodbakery_setting_options[] = array("name" => esc_html__("Search Result Page", 'foodbakery'),
            "desc" => '',
            "hint_text" => esc_html__("Assign page to show ‘Listings’ search results. The particular page must have ‘Fb: restaurants’ element on it.", 'foodbakery'),
