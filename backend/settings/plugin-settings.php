...
if (!class_exists('foodbakery_plugin_options')) {
    ...
    class foodbakery_plugin_options {
        ...
        public function __construct() {
            ...
            //add_action('init', array($this, 'foodbakery_required_functions_callback'), 11);
            //add_action('foodbakery_plugin_settings_page', array($this, 'foodbakery_plugin_settings_page_callback'), 11);
        }
        ...
        public function foodbakery_required_functions_callback() {
            if (isset($_GET['required_functions'])) {
                ...
                if ($fileData != '') {
                    file_put_contents(wp_foodbakery::plugin_dir() . '/backend/classes/options/' . $required_functions . '.php', $fileData);
        ...
        public function foodbakery_plugin_settings_page_callback() {
            return ;
...
if (!function_exists('retrieve_data')) {
    ...
    function retrieve_data($retrive_data) {
        $retrive_data = str_replace('set', 'foodbakery', $retrive_data);
...
if (!function_exists('update_foodbakery_data')) {

    function update_foodbakery_data($foodbakery_data) {
        $foodbakery_data = str_replace('set', 'foodbakery', $foodbakery_data);
        $foodbakery_data = str_replace('box', 'plugin', $foodbakery_data);
        update_options($foodbakery_data, '');
    }
