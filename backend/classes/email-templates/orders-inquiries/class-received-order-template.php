...
if (!class_exists('Foodbakery_received_order_email_template')) {
    ...
    class Foodbakery_received_order_email_template
    {
        ...
        public function __construct()
        {
            ...
            $this->email_template_variables = apply_filters('received_order_template', $this->email_template_variables, $this->order_id);
        ...
        function get_order_payment_method()
        {
            global $gateways;
            $trans_id = $this->get_trans_id($this->order_id);
            
            $foodbakery_trans_gate = get_post_meta($trans_id, "foodbakery_transaction_pay_method", true);
            $payment_method = '';
            if ($foodbakery_trans_gate != '') {
                ...
                $payment_method = esc_html($foodbakery_trans_gate);
            }
