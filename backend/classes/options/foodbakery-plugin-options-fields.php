<?php if (!class_exists('foodbakery9800bakery_options_fields')) {

    class foodbakery9800bakery_options_fields {
         ...
         */
        public function foodbakery9800bakery_fields($foodbakery_setting_options) {
