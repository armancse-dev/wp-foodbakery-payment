	...
	class foodbakery_form_fields {
		...
		public function foodbakery_form_date_render($params = '') {
			...
			$prefix_enable = 'true'; // default value of prefix add in name and id
                        ...
                        $date_range = isset( $date_range )? $date_range : false;
				...
				$html_id = '';
                        ...
                        if( $date_range == true){
                            ...
                            $foodbakery_output .= '<script>
                                jQuery(function(){
                                    jQuery("#' . $prefix . $foodbakery_piker_id . '").daterangepicker({
                                        locale: {
                                            format: "MM/DD/YYYY"
                                        },  
                                        ranges: {
			...
			if ( isset($div_classes) && $div_classes <> "" ) {
				$foodbakery_output .= '</div>';
                        ...
                        if (isset($condition) && !empty($condition)) {
                            $cust_name = isset( $cust_name )? $cust_name : $prefix . sanitize_html_class($id);
                            if( $cust_name != ''){
                                $foodbakery_output .= '<script type="text/javascript">jQuery(document).ready(function () {  ';

                                foreach ($condition as $condition_value => $condition_fields) {
                                    $foodbakery_output .= 'jQuery(document).on("change", "select[name=\"' . $cust_name . '\"]", function () { console.log("testing33311111113"); ';

                                    if (!empty($condition_fields)) {
                                        foreach ($condition_fields as $condition_field) {
                                            $condition_field = "'" . $condition_field . "'";
                                            $foodbakery_output .= 'var current_value = jQuery(this).val();
                                                if ( current_value == "' . $condition_value . '" ){
                                                    //jQuery("[name=' . $condition_field . ']").closest(".form-elements").show();
                                                    jQuery("[name=' . $condition_field . ']").closest(".form-elements-condition").show();
                                                }else{
                                                    //jQuery("[name=' . $condition_field . ']").closest(".form-elements").hide();
                                                    jQuery("[name=' . $condition_field . ']").closest(".form-elements-condition").hide();
                                                }';
                               ...
                               $foodbakery_output .= 'jQuery("select[name=\"' . $cust_name . '\"]").trigger("change"); });</script>';
                            }
                        ...
                        if (isset($multi_condition) && !empty($multi_condition)) {
                            $cust_name = isset( $cust_name )? $cust_name : $prefix . sanitize_html_class($id);
                            if( $cust_name != ''){
                                $foodbakery_output .= '<script type="text/javascript">jQuery(document).ready(function () { ';

                                foreach ($multi_condition as $condition_value => $condition_fields) {
                                    $foodbakery_output .= 'jQuery(document).on("change", "select[name=\"' . $cust_name . '\"]", function () {  ';
                                    ...
                                    if (!empty($condition_fields)) {
                                        foreach ($condition_fields as $condition_field) {
                                            ...
                                            $foodbakery_output .= 'var current_value = jQuery(this).val();
                                                if ( current_value == "' . $condition_value . '" ){
                                                    jQuery(this).closest("li").find("[name=' . $condition_field . ']").closest(".form-elements").show();
                                                }else{
                                                    jQuery(this).closest("li").find("[name=' . $condition_field . ']").closest(".form-elements").hide();
                                                }';
		...
		public function foodbakery_form_multiselect_render($params = '') {
			...
			$foodbakery_onchange = $foodbakery_value = '';
