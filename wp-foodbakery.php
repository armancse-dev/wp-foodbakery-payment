...
if (!class_exists('wp_foodbakery')) {
    ...
    class wp_foodbakery {
        ...
        public function __construct() {
            ...
            add_action('foodbakery_load_folder', array($this, 'foodbakery_load_folder_callback'));
            $this->includes();
        ...
        public function foodbakery_load_folder_callback($folder_path){
            foreach (glob(wp_foodbakery::plugin_dir().'/'.$folder_path.'/'.'*.php') as $filename){
        ...
        public function includes() {
             ...
             * Email Templates.
             */
            //require_once 'backend/classes/foodbakery-authentication.php';
            ...
            require_once 'backend/classes/foodbakery-deal-backend.php';
            require_once 'frontend/classes/foodbakery-deal-frontend.php';
        ...
        public function foodbakery_defaultfiles_plugin_enqueue() {
            global $foodbakery_plugin_options, $foodbakery_var_options;
            // admin styles
            if (is_admin()) {
                wp_enqueue_media();
            }
            ...
            // temprary off
            if (!is_admin()) {
				$foodbakery_location_autocomplete = isset( $foodbakery_plugin_options['foodbakery_location_autocomplete'] )? $foodbakery_plugin_options['foodbakery_location_autocomplete'] : 'off';
                ...
                wp_localize_script(
                    ...
                    'required_string' => esc_html__('Required Fields', 'foodbakery'),
					'foodbakery_location_autocomplete' => $foodbakery_location_autocomplete,
                        )
                );
                ...
                //wp_enqueue_script('foodbakery-slide-menu', plugins_url('/assets/frontend/scripts/slide-menu.js', __FILE__), '', '', true);
                wp_localize_script(
                    ...
                    'menu_hide_height' => isset( $foodbakery_var_options['foodbakery_var_menu_hide_height'] )? $foodbakery_var_options['foodbakery_var_menu_hide_height'] : 0,
                        )
                );
                /*
        ...
        function create_restaurant_settings() {
            ...
            require_once 'api/cousine_api.php';
            require_once 'api/restaurant_api.php';
